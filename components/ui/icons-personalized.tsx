...
export const CartaoIcon = (props: any) => (
...
export const BanknoteArrowUp = (props: any) => (
  <Svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
...
export const BanknoteArrowDown = (props: any) => (
  <Svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
